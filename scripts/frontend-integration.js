 ...
 * This file demonstrates how to integrate Emberrift with a web frontend
 */

// For React/Vue/Angular applications
export class EmberriftClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new EmberriftClient(provider, contractAddress);
